...
const RESULTS: {
...
}[] = [
    {
        icon: Leaf,
        title: "Свобода",
        desc: "Мы не бегаем чтоб успеть все. Мы гуляем по ущельям, штольням, лесам, по кромке Днестра, смотрим на первоцветы, вдаль на обзорных площадках, пинаем осенние листья и ловим лучшие закаты.",
    ...
    },
    {
        icon: Coffee,
        title: "Атмосфера",
        desc: "Разговоры о жизни в пути, которых так не хватает в суете города. Иногда делаем чай  или полевое питание. Главное мы создаем условия для наслаждения моментом",
    ...
    },
    {
        icon: Wind,
        title: "Замедление",
        desc: "Каждый шаг как знакомство с собой и людьми вокруг, которое рождает ощущение родной землки.  Да и просто смотреть в бескрайнее небо, а еще у нас есть гамаки.",
        color: "text-blue-400",
        bg: "bg-blue-500/10",
