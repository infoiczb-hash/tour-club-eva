...
import { Flame, Compass, Users, ArrowRight, Smartphone, Frown, User, ChevronRight } from 'lucide-react';
    ...
    return (
        <section className="py-8 md:py-16 bg-slate-950 relative overflow-hidden">
             <div className="container mx-auto px-4 max-w-6xl relative z-10">
                 ...
                 <FadeBlock startX={-20} startY={0} className="text-left mb-8 md:mb-12">
