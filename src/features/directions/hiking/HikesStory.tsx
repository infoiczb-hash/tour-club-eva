        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            >
                ...
                <div className="text-lg md:text-xl font-medium leading-relaxed space-y-6 text-stone-400">
                    <p>Вчера мы стояли над облаками в Трансильвании.</p>
                    <p>Горячий чай из термоса, звенящая тишина и осознание того, что все городские дедлайны остались где-то далеко внизу.</p>
                </div>
