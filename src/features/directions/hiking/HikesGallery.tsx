...
const GALLERY_ITEMS = [
    {
        id: 1, title: "Масштаб", subtitle: "Среди величественных вершин", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838444/photo_5294161935740294707_w_osfd8l.jpg",
        className: "md:col-span-2 md:row-span-2 h-[400px] md:h-full",
    },
    {
        id: 2, title: "Атмосфера", subtitle: "Туманные рассветы", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838472/8_mb7oso.jpg",
        className: "md:col-span-2 md:row-span-1 h-[400px] md:h-auto",
    },
    {
        id: 3, title: "Моменты", subtitle: "Красота в деталях", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838488/%D0%BE%D1%81%D0%B5%D0%BD%D1%8C8_m6f3ja.jpg",
        className: "md:col-span-1 md:row-span-1 h-[400px] md:h-auto",
    },
    {
        id: 4, title: "Привал", subtitle: "Отдых на тропе", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838501/1%D0%BE%D1%81%D0%B5%D0%BD%D1%8C_helnpn.jpg",
        className: "md:col-span-1 md:row-span-1 h-[400px] md:h-auto",
    },
    {
        id: 5, title: "Путь", subtitle: "Дорога к облакам", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838649/3_x7hpes.jpg",
        className: "md:col-span-2 md:row-span-1 h-[400px] md:h-auto",
    },
    {
        id: 6, title: "Свобода", subtitle: "Весь мир на ладони", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838760/8_e69ysh.jpg",
        className: "md:col-span-1 md:row-span-1 h-[400px] md:h-auto",
    },
    {
        id: 7, title: "Команда", subtitle: "Вместе теплее", img: "https://res.cloudinary.com/dwrei7k2z/image/upload/v1771838702/photo_5449540439326709334_y_rksj5c.jpg",
        className: "md:col-span-1 md:row-span-1 h-[400px] md:h-auto",
    }
];
                    ...
                    <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-10 md:pb-0 -mx-4 px-4 md:grid md:grid-cols-4 md:auto-rows-[250px] md:gap-4 md:mx-0 md:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                        {GALLERY_ITEMS.map((item, i) => (
                            <div
                                key={item.id}
                                className={cn(
                                    "relative shrink-0 snap-center w-[85vw] md:w-auto rounded-[2rem] overflow-hidden group isolate border border-white/10 bg-stone-900 shadow-xl cursor-pointer animate-in fade-in slide-in-from-bottom-8 fill-mode-both",
                                    item.className
                                )}
