...
// 7 РЕАЛЬНЫЕ ФОТОГРАФИИ (Bento-структура для десктопа)
const GALLERY_ITEMS = [
    {
        id: 1,
        title: "Масштаб",
    ...
    return (
        ...
        <section className="py-8 md:py-16 bg-stone-950 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                ...
                <div 
                    className="text-left mb-8 md:mb-12 max-w-3xl animate-in fade-in slide-in-from-left-8 duration-700 fill-mode-both"
                >
                        ...
                        {GALLERY_ITEMS.map((item, i) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    "relative shrink-0 snap-center w-[85vw] md:w-auto rounded-[2rem] overflow-hidden group isolate border border-white/10 bg-stone-900 shadow-xl cursor-pointer animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-both",
                                    item.className
                                )}
