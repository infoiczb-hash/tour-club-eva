// src/features/directions/hiking/HikesLogistics.tsx
"use client";
...
const logisticsData = [
    {
        icon: Bus,
        title: "Транспорт",
        desc: "Едем на комфортных микроавтобусах прямо из ПМР/Молдовы до точки старта маршрута. Никаких сложных пересадок с тяжелыми рюкзаками по вокзалам."
    },
    {
        icon: Tent,
        title: "Ночевки",
