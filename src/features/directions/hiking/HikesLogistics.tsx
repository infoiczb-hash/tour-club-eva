...
const LOGISTICS = [
    ...
    },
    {
        icon: Backpack,
        title: "Снаряжение",
        desc: "Мы предоставляем обещственное снаряжение. Личное (рюкзак, спальник) — ваше. Перед походом даем подробный гайд, чтобы вы не несли лишнего. Если что-то надо найдем для Вас или скажем где взять."
    },
    {
        icon: ShieldCheck,
        title: "Безопасность",
        desc: "Берем аптечку. На сложных маршрутах регистрируемся у спасателей. Гид всегда контролирует темп группы, в целях группового комфорта и безопасности."
    }
];
