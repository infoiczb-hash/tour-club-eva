...
const LOGISTICS = [
    {
        icon: Bus,
        title: "Транспорт",
        desc: "Едем на комфортных микроавтобусах прямо из ПМР/Молдовы до точки старта маршрута. Никаких сложных пересадок с рюкзаками по вокзалам."
    },
    {
        icon: Tent,
        title: "Ночевки",
        desc: "Спим в современных 2-3 местных палатках в кемпингах или диких условиях. На некоторых маршрутах останавливаемся в уютных горных приютах."
    },
    {
        icon: Backpack,
        title: "Снаряжение",
        desc: "Общественное (палатки, котлы, горелки) — наше. Личное (рюкзак, спальник) — ваше. Перед походом даем подробный гайд, чтобы вы не несли лишнего."
    },
    {
        icon: ShieldCheck,
        title: "Безопасность",
        desc: "Регистрируем группы у спасателей, берем аптечку. Гид всегда контролирует темп, чтобы комфортно было абсолютно каждому участнику."
    }
];
                    ...
                    >
                        <div className="bg-stone-900/50 p-8 md:p-10 rounded-[2.5rem] border border-stone-800 shadow-2xl relative backdrop-blur-sm">
                            ...
                            <p className="text-stone-400 font-medium leading-relaxed mb-10 relative z-10 text-sm md:text-base">
                                «Поход — это ваш личный отдых, а не испытание на прочность. Моя главная задача как гида — взять на себя всю логистику, навигацию и быт, чтобы вы могли просто идти, дышать и впитывать красоту вокруг. Мы проходим маршрут вместе, в темпе самого медленного участника. Никто не останется один.»
                            </p>
