...
const timeline = [
  { time: "08:00-09:00", title: "Сбор и встреча", desc: "Знакомство с гидом. Детальный инструктаж, распределение байдарок и инвентаря.", icon: Coffee },
  { time: "9:00-10:00", title: "Спуск на воду", desc: "Первые неуверенные гребки быстро сменяются синхронной работой. Входим в ритм реки.", icon: Waves },
  { time: "13:30", title: "Большой привал", desc: "Швартуемся на пляже. Купаемся, загораем и наслаждаемся Днестром в тени деревьев.", icon: Tent },
  { time: "17:00-19:00", title: "Финиш", desc: "Выходим на берег, сдаем инвентарь. Трансфер забирает нас обратно. Обмениваемся фото.", icon: Flag },
];
...
export default function Timeline() {
  return (
    <section className="py-12 md:py-20 bg-[#020617] relative overflow-hidden font-sans border-t border-white/5">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-emerald-900/5 md:blur-[120px] rounded-full pointer-events-none" />
