  ...
  return (
    <section className="py-10 md:py-14 bg-[#020617] relative overflow-hidden font-sans">
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        <div
          className="relative p-8 md:p-16 rounded-[2.5rem] md:rounded-[3rem] bg-gradient-to-br from-teal-900/40 via-slate-900 to-[#020617] border border-teal-500/20 overflow-hidden text-center flex flex-col items-center shadow-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-both"
        >
