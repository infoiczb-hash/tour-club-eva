  ...
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden bg-slate-950 flex flex-col items-center justify-center">
      ...
      <div ref={bgRef} className="absolute inset-0 z-0" style={{ willChange: 'transform' }}>
        <Image
          src="https://res.cloudinary.com/dwrei7k2z/image/upload/v1771584228/%D0%B8%D0%B7%D0%BE%D0%B1%D1%80%D0%B0%D0%B6%D0%B5%D0%B1%D0%B8%D0%B5_viber_2025-06-21_11-50-14-080_a7uba5.jpg"
      ...
      >
        ...
        {/* ОПТИМИЗИРОВАНО: Убрано opacity-0, добавлен animate-in. Текст не прячется от роботов */}
