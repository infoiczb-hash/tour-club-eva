  ...
  return (
    <section className="py-10 md:py-12 bg-slate-950 relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div
          ref={refGrid}
          className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 -mx-4 px-4 md:grid md:grid-cols-3 lg:grid-cols-6 md:gap-5 md:overflow-visible md:pb-0 md:mx-0 md:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
        >
          {FORMATS.map((format, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'group relative flex-shrink-0 snap-center w-[160px] sm:w-[180px] md:w-auto h-[140px] md:h-[160px]',
                  'bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-3xl flex flex-col items-center justify-center gap-4',
                  'cursor-pointer overflow-hidden transition-all duration-500 hover:border-teal-500/50 hover:bg-slate-900/80 shadow-lg',
