        ...
        <section className="py-8 md:py-12 bg-slate-950 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    {/* БЛОК 1: Чек-лист */}
                    <div className="bg-slate-900/80 backdrop-blur-sm border border-white/5 hover:border-teal-500/30 transition-colors rounded-[2rem] p-6 md:p-8 flex flex-col h-full group animate-in fade-in slide-in-from-left-8 duration-700 fill-mode-both">
                    ...
                    {/* БЛОК 2: Своя доска */}
                    <div className="bg-slate-900/80 backdrop-blur-sm border border-white/5 hover:border-teal-500/30 transition-colors rounded-[2rem] p-6 md:p-8 flex flex-col h-full group animate-in fade-in slide-in-from-right-8 duration-700 delay-150 fill-mode-both">
                        <div className="flex flex-row items-center gap-4 mb-5 md:mb-6">
                            <div className="w-12 h-12 rounded-2xl bg-teal-500/10 flex items-center justify-center border border-teal-500/20 shrink-0 group-hover:bg-teal-500 group-hover:text-slate-900 transition-colors duration-300">
