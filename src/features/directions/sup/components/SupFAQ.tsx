...
const FAQ_DATA = [
    ...
    { 
        ...
        a: "Падения случаются, и это часть веселья! Во-первых, вы будете в страховочном жилете. Во-вторых, к вашей ноге пристегнут страховочный лиш (трос), поэтому доска никуда не уплывет. Инструктор покажет, как легко забраться обратно на доску из воды."
    },
    {
        q: "Можно ли взять с собой телефон на воду?",
        a: "Да, конечно. Мы настоятельно рекомендуем использовать специальные водонепроницаемые чехлы на шнурке (гермочехлы), которые вешаются на шею. Без чехла брать телефон на доску мы категорически не советуем — риск утопить его очень высок. Чехол можно попросить перед выходом на воду при получении жилета."
    }
];
