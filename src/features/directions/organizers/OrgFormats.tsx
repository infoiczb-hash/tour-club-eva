...
const FORMATS = [
    ...
    },
    {
        ...
        desc: "Это микс ваших знаний и наших умений в природе-терапии. Идельно для форматов йога, психология, медитации, трансформационных игр. Наша роль может быть разной, надо обсуждать",
