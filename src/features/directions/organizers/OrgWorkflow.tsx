...
const STEPS = [
    ...
    },
    {
        ...
        desc: "В течение 1-2 дней мы присылаем вам презентацию с вариантами маршрута и подробную, прозрачную смету до копейки. Мы сразу закладываем все расходы: от трансфера до салфеток.",
        result: "Утвержденный план без скрытых доплат."
    },
    {
        num: "03",
        title: "Реализация",
        icon: TentTree,
        desc: "Мы закупаем продукты, готовим снаряжение, организуем логистику. В день «Х» вы и ваша команда просто садитесь в комфортный автобус и начинаете отдыхать. Завхоз вам больше не нужен.",
        result: "100% готовность лагеря и маршрута."
    }
];
            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                ...
                >
                    ...
                    <p className="text-slate-400 font-medium text-lg max-w-2xl mx-auto">
                        Прозрачный алгоритм без неприятных сюрпризов. Мы ценим ваше время, поэтому согласование проходит максимально быстро.
                    </p>
                </motion.div>

                {/* Инфографика - Шаги */}
                <div className="relative">
                    {/* Соединительная линия (скрыта на мобилках) */}
