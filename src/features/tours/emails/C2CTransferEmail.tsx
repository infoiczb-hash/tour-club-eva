        ...
        <Container className="mx-auto my-10 p-4 max-w-[600px]">
          ...
          <Section className="mb-8">
            ...
            <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 text-center shadow-sm">
              <Text className="m-0 mb-1 text-xs uppercase tracking-widest text-slate-400 font-bold">Ваш билет</Text>
          ...
          <Section className="text-center">
            <Text className="text-xs text-slate-300">Турклуб ЭВА. До встречи на маршруте!</Text>
          </Section>
        </Container>
      </Body>
    </Tailwind>
