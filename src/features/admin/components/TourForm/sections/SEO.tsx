      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
           <div className="relative">
              ...
              />
              <div className={`text-[10px] text-right mt-1 font-bold ${metaTitle.length > 60 ? 'text-rose-500' : 'text-slate-400'}`}>
           ...
           <div className="relative">
              ...
              />
              <div className={`text-[10px] text-right mt-1 font-bold ${metaDesc.length > 160 ? 'text-rose-500' : 'text-slate-400'}`}>
