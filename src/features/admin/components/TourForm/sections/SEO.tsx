      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
           <div className="relative">
              ...
              />
              <div className={`text-[12px] text-right mt-1 font-bold ${metaTitle.length > 60 ? 'text-rose-500' : 'text-slate-600'}`}>
           ...
           <div className="relative">
              ...
              />
              <div className={`text-[12px] text-right mt-1 font-bold ${metaDesc.length > 160 ? 'text-rose-500' : 'text-slate-600'}`}>
        ...
        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
           <h4 className="text-xs font-bold uppercase text-slate-600 mb-4 flex gap-2 items-center">
             <Globe size={14}/> Предпросмотр в Google
           </h4>
           
           <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-100">
              <div className="flex items-center gap-2 mb-1">
                 <div className="w-6 h-6 rounded-full bg-slate-200 flex items-center justify-center text-[12px] text-slate-600">Logo</div>
                 <div className="flex flex-col">
                    <span className="text-[12px] text-slate-800 font-bold">Ваш Сайт</span>
                    <span className="text-[12px] text-slate-600">https://vash-site.com/tours/...</span>
                 </div>
              </div>
           ...
           <p className="text-[12px] text-slate-600 mt-4 leading-tight">
