    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
           <h4 className="text-xs font-black uppercase text-slate-300 mb-2">Спец. тарифы</h4>
        ...
        {/* Места */}
        <div className="space-y-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
          <h4 className="text-xs font-black uppercase text-slate-300 mb-2">Управление местами</h4>
          <FormInput name="spots" label="Всего мест" type="number" />
          <FormInput name="spotsLeft" label="Осталось мест" type="number" />
          <p className="text-[12px] text-slate-300 leading-tight mt-2">
