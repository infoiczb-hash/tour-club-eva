        ...
        <div className="space-y-5">
          ...
          <div className="flex items-end gap-2">
             ...
             <button 
                ...
                className="h-[44px] px-3 bg-slate-100 hover:bg-teal-50 text-slate-600 hover:text-teal-600 rounded-xl border border-slate-200 transition-colors flex items-center justify-center mb-6" 
          ...
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 space-y-4">
             <h4 className="text-xs font-black uppercase text-slate-600 mb-2">Детализация для карточки</h4>
        ...
        <div className="space-y-6">
           ...
           <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <label className="aspect-square rounded-lg border-2 border-dashed border-slate-300 hover:border-teal-500 hover:bg-teal-50 flex flex-col items-center justify-center cursor-pointer transition-colors text-slate-600 hover:text-teal-600">
                  <Plus size={24} />
