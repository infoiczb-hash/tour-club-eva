      ...
      <div className="bg-white dark:bg-slate-950 rounded-2xl w-full max-w-lg shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
          <div>
            ...
            <p className="text-xs text-slate-800 font-medium">Вставьте любой текст (пост, PDF, сообщение)</p>
          </div>
          <button onClick={onClose} className="text-slate-800 hover:text-slate-800 dark:hover:text-slate-800 transition">
            <X size={24} />
          </button>
        </div>
        ...
        <div className="p-6 space-y-4">
          <div className="relative">
            <textarea
              ...
              className="w-full h-64 p-4 text-sm bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none resize-none dark:text-white placeholder:text-slate-800 transition-all"
...
AI сам разложит всё по полочкам."
            ...
            {!text && (
              <button 
                onClick={handlePaste}
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-slate-800 shadow-lg border border-slate-100 dark:border-slate-700 px-4 py-2 rounded-full text-xs font-bold text-slate-800 dark:text-slate-800 flex items-center gap-2 hover:scale-105 transition-transform"
              >
