                    ...
                    <tr key={post.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition">
                      ...
                      <td className="p-5 text-center">
                        <button 
                          ...
                          className={`p-1.5 rounded-lg transition ${post.is_trending ? 'text-amber-500 bg-amber-50 dark:bg-amber-900/20' : 'text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                        >
