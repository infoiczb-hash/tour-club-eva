...
// Тип уведомления из Prisma (можно импортировать из @prisma/client)
...
export function NotificationBell() {
  ...
  // Загрузка и автообновление каждые 60 секунд
  useEffect(() => {
    fetchNotifications();
              ...
              <div className="flex flex-col">
                {notifications.map((n) => (
                  <Link
                    ...
                    className={cn(
                      'flex items-start gap-3 p-4 border-b border-gray-50 dark:border-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors',
