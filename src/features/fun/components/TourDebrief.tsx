    ...
    <AnimatePresence>
      <motion.div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/90 backdrop-blur-xl px-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        ...
        >
          ...
          {step === "result" && (
            <motion.div key="result" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col h-full overflow-hidden p-6 md:p-10 pb-6">
                ...
                {answeredCount === 0 ? (
                   <div className="border border-slate-700 bg-slate-800/30 rounded-3xl p-6 md:p-8 text-center relative overflow-hidden h-full flex flex-col justify-center">
                     ...
                     <div className="flex flex-col gap-3 relative z-10 w-full max-w-sm mx-auto">
                       <Link href="/tour" onClick={onClose} className="w-full bg-violet-600 hover:bg-violet-500 text-white rounded-xl py-3.5 text-sm font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-lg shadow-violet-600/20">
                         <Compass size={16} /> Выбрать новый тур
                       </Link>
                       <button onClick={() => { setStep("intro"); setCurrent(0); setAnswers({}); }} className="w-full bg-white/5 hover:bg-white/10 text-white rounded-xl py-3.5 text-sm font-bold uppercase tracking-wider transition-colors">
                         Начать заново
                       </button>
                     </div>
                   </div>
                      ...
                      <div className="pt-8 mt-6 border-t border-white/10 text-center animate-in fade-in duration-500">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                          ...
                          <Link
                            href="/tour"
                            onClick={onClose}
                            className="flex-1 py-4 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-bold text-[11px] uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg shadow-violet-900/20"
                          >
