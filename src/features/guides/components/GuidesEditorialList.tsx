        ...
        <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex flex-col gap-24 md:gap-32 pb-24">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="relative mt-12 bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-[3rem] p-8 md:p-16 text-center overflow-hidden shadow-2xl"
                >
...
function EditorialGuideBlock({ guide, index }: { guide: Guide, index: number }) {
    ...
    return (
        <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center relative"
        >
            {/* КОЛОНКА 1: ФОТО */}
            <div className={cn(
