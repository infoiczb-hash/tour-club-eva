...
export default function PrivacyPage() {
  return (
    ...
    <BreadcrumbJsonLd items={[
      ...
      { name: "Политика конфиденциальности", url: "https://evatur.club/privacy" },
    ]} />
    <main className="min-h-screen bg-slate-950 pt-24 md:pt-32 pb-16 md:pb-20 px-4 relative overflow-hidden">
      
      {/* Background Decor */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-teal-900/20 md:blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto max-w-3xl relative z-10">
        ...
        <div className="mb-8 md:mb-12">
            ...
            <div className="inline-flex items-center gap-2 md:gap-3 text-slate-300 text-xs md:text-sm font-medium bg-slate-900/50 p-4 rounded-xl border border-white/5">
        ...
        <div className="prose prose-sm md:prose-lg prose-invert max-w-none 
            ...
            <section className="mb-8 md:mb-10">
                ...
                <p>Туристический клуб «Эва» уважает ваше личное пространство. Мы собираем только те данные, которые реально нужны для организации вашего тура или мероприятия.</p>
            ...
            <section className="mb-8 md:mb-10">
                ...
                <p>Путешествия — это эмоции, и мы любим их сохранять!</p>
                <ul>
                    <li><strong>Съемка гидами:</strong> Во время туров наши гиды могут делать фото и видео для отчетов в социальных сетях и на сайте. Участвуя в туре, вы даете на это согласие. Если вы категорически против съемки — просто предупредите гида заранее, мы уважаем ваше право на приватность.</li>
                    <li><strong>Ваш контент:</strong> Мы приветствуем, когда участники добровольно делятся своими кадрами и видео с туров. Отправляя нам материалы, вы разрешаете использовать их в наших соцсетях и на сайте для вдохновения других путешественников.</li>
                </ul>
            </section>

            <section className="mb-8 md:mb-10">
                <h2>4. Передача данных</h2>
                <p>Мы не продаем и не передаем ваши контакты спамерам. Ваши данные могут быть переданы третьим лицам только в случаях, необходимых для исполнения тура:</p>
                <ul>
            ...
            <section className="mb-8 md:mb-10">
                <h2>5. Согласие</h2>
                <p>Оставляя заявку на сайте, бронируя тур или вступая в чат поездки, вы подтверждаете, что ознакомились с данной политикой и принимаете её условия.</p>
            </section>
